    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Image.asset('assets/plant_based_protein.jpg'),
          SizedBox(height: 16),
          Text(
          ...
          SizedBox(height: 8),
          buildContactItem('dr. Nadin Amizah, Sp. GK', '15 years',
              'Rumah Sakit Hermina Pasteur', 'assets/doctor1.jpg'),
          buildContactItem('Dr. Rendy Pratama, Sp. GK', '10 years',
              'Rumah Sakit Siloam', 'assets/doctor2.jpg'),
          buildContactItem('Dr. Teddy Asdhira, Sp. GK', '8 years',
              'Rumah Sakit Medistra', 'assets/doctor3.jpg'),
        ],
      ),
    );
  }
